...
import com.www.yhy.domain.User;
...
public class TestCRUDByXmlMapper {
	 ...
	 @Test
	    ...
	    public void testUpdate(){
	         ...
	         */
	        String statement = "com.www.yhy.mapping.userMapper.updateUser";//映射sql的标识字符串
	        User user = new User();
	        user.setId(3);
	        user.setName("孤傲苍狼");
	        user.setAge(25);
	    ...
	    public void testDelete(){
	         ...
	         */
	        String statement = "com.www.yhy.mapping.userMapper.deleteUser";//映射sql的标识字符串
	        //执行删除操作
	    ...
	    public void testGetAll(){
	         ...
	         */
	        String statement = "com.www.yhy.mapping.userMapper.getAllUsers";//映射sql的标识字符串
